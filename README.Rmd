...
# LAPP : Ligand Analysis with Physicochemical Properties
...
features.4A= conv.features.list(ligands, convmat.24, 9)
...
# plot PCA
plot.pep.pca(features.4A.pca, type= "density", color= colors)
